...
<!-- FastClick -->     
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/fastclick-1.0.6/lib/fastclick.js"></script>
<!-- NProgress -->     
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/nprogress-0.2.0/nprogress.js"></script>
<!-- Chart.js -->
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/Chart.js/Chart.js"></script>
<!-- gauge.js -->     
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/gauge.js-1.3.3/dist/gauge.js"></script>
<!-- bootstrap-progressbar与easyui-1.5.1中progress冲突 -->
<!-- <script type="text/javascript" src="${pageContext.request.contextPath}/jslib/bootstrap-progressbar-0.9.0/bootstrap-progressbar.js"></script> -->

<!-- iCheck --> 
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/icheck-1.0.2/icheck.js"></script>
<!-- Skycons -->
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/skycons/skycons.js"></script>
<!-- Flot -->
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/flot-0.8.3/jquery.flot.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/flot-0.8.3/jquery.flot.pie.js"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/jqvmap-1.5.1/dist/maps/jquery.vmap.world.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/jqvmap-1.5.1/examples/js/jquery.vmap.sampledata.js"></script>
<!-- bootstrap-daterangepicker -->
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/bootstrap-daterangepicker-2.1.25/moment.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/bootstrap-daterangepicker-2.1.25/daterangepicker.js"></script>
<!-- pnotify-3.2.0 -->
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/pnotify-3.2.0/dist/pnotify.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/pnotify-3.2.0/dist/pnotify.buttons.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/pnotify-3.2.0/dist/pnotify.nonblock.js"></script>
